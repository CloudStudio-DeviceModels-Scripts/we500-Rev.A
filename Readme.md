...
# Parsing + Configuration Script – we500 - Rev. A

This **Parsing + Configuration** script is designed for the **we500** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – we500 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **we500** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
